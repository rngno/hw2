...
OBJS=amazon.o user.o db_parser.o product.o product_parser.o util.o book.o clothing.o movie.o
...
amazon.o: amazon.cpp db_parser.h datastore.h product_parser.h book.h clothing.h movie.h user.h util.h
